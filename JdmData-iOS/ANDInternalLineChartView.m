...
- (void)setupGradientLayer{
  ...
  CGColorRef color1 =  [UIColor colorWithRed:204 /255.0 green:233/255.0  blue:244/255.0  alpha:0.7].CGColor;
  CGColorRef color2 =  [UIColor colorWithRed:204 /255.0 green:233/255.0  blue:244/255.0  alpha:0.7].CGColor;
...
- (void)layoutSubviews{
  [super layoutSubviews];
     [_graphLayer setFrame:CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height)];
//  [_graphLayer setFrame:[self bounds]];
  [_maskLayer setFrame:CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height )];
  [_gradientLayer setFrame:CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height )];
